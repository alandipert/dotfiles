...
obj.defaultHotkeys = {
   --left_half   = { {"ctrl",        "cmd"}, "Left" },
   --right_half  = { {"ctrl",        "cmd"}, "Right" },
   left_twothird   = { {"ctrl",        "cmd"}, "Left" },
   right_twothird  = { {"ctrl",        "cmd"}, "Right" },
   top_half    = { {"ctrl",        "cmd"}, "Up" },
   bottom_half = { {"ctrl",        "cmd"}, "Down" },
   third_left  = { {"ctrl", "alt"       }, "Left" },
   third_right = { {"ctrl", "alt"       }, "Right" },
...
function obj.resizeCurrentWindow(how, use_fc_preference)
   ...
   elseif how == "left_twothird" then
      newrect = {0,0,2/3,1}
   elseif how == "right_twothird" then
      newrect = {1/3,0,2/3,1}
   elseif how == "top" then
      newrect = {0,0,1,0.5}
...
obj.leftTwothird       = hs.fnutils.partial(obj.resizeCurrentWindow, "left_twothird")
obj.rightTwothird      = hs.fnutils.partial(obj.resizeCurrentWindow, "right_twothird")
...
function obj:bindHotkeys(mapping)
   local hotkeyDefinitions = {
      ...
      left_twothird = self.leftTwothird,
      right_twothird = self.rightTwothird,
